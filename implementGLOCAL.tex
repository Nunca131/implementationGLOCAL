...
%\subsection{Data}
% I think this will be sufficiently little text that we don't need
% subsection headings :)
...
\TODO{* what tools do we benchmark against, and why? *} 
\FK{We benchmark agains t\_coffee, mafft and clustalW}

\TODO{Falco: include benchmark results as graphics. Ideally we should not
  be massively slower than other exact tools for only global input
  sequences.}

\FK{  
\begin{figure}
  \begin{center}
    \includegraphics[width=1\columnwidth]{time_smaller4.eps}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=1\columnwidth]{time_bigger3.eps}
  \end{center}
