...
step for cleaning initial alignments before the release.  \PFS{Both
...
\begin{figure}
  ...
  \end{center}
  \caption{\PFS{Distribution of the local ends in the benchmark
      alignments.}  \TODO{normalisieren mit der Anzahl aller Enden.}}
  \label{fig:locs}
\end{figure}
