...
common alignment tools: \texttt{T-Coffee} \cite{***}, \texttt{MAFFT}
\cite{***}, and \texttt{ClustalW} \cite{***}. \PFS{All three tools are
  based on initial pairwise alignments and use essentially progressive
  schemes, hence presenting efficient heuristics rather than exact
  solutions.}
...
\NR{To test how many alignment columns are correctly aligned we first enumerated }
