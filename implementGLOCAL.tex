...
% ((Position shift error in alignments created with \SAFTWARE{} is
% significantly worse than in the other alignments based on t\_coffee, mafft
% and clustalW. Big position shift errors may arise from alignments with
% sequences with local ends, which are handled locally in \SAFTWARE{} and
% globally in the other alignment tools. The comparison on an alignment where
