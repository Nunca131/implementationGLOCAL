...
\newcommand{\SAFTWARE}{\texttt{uniAlign}} %{\TODO{\texttt{SAFTWARE}}}
...
Comparing \PFS{the performance for few and many local ends, respectively,
...
with the nummer of local ends. Since \SAFTWARE{} is designed as a reference
