...
\FK{
This implementation is not yet optimized in terms of performance. One solution could be an approach of parallelization, namely fine grained multithreading \cite{Martins:01}.}
