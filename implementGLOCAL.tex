...
\citet{Chatzou:16,Baichoo:17,Nute:18} for a recent reviews.
...
\PFS{The computational efforts for exact dynamic programming algorithms
  ...
  \cite{Schroedl:05,Bilu:06}.  Quasi-alignments based on $k$-mer matches
