...
\PFS{The backtracing recursion is a rather straightforwards generalization
  ...
  step is to find the score optimal partially local alignment. Denote by
  $^{(A^*,D^*)}$ that unique maximal state w.rt.\ $preceq$, i.e., $A^*$ is
  ...
  The optimal score is the maximum over all multiindices $I$ with
...
alignments with additive gap costs as outline in the previous section.
...
sequences must pass through all three states. All combinations of these
