...
\begin{figure}
	...
	\end{center}
\caption{blubb \TODO{normalisieren mit der Anzahl aller Enden? So wie es im Text 
		steht ergibt es keinen Sinn, da man ja bis zu 2 Lokalit\"{a}ten pro Sequenz haben 
	kann.}}
\label{fig:locs}
\end{figure}
